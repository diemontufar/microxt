 ...
 * Values of person types
 */
@Entity
@Table(name = "PERSON_TYPE")
public class PersonType extends AbstractEntity implements Multicompany, Multilanguage {
    ...
    public String toString() {
        return "PERSON_TYPE:[" + this.getPk().toString() + ", " + this.getName()
                + "]";
    }
}
