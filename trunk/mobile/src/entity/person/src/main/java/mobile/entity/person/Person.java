...
public class Person extends AbstractHistoricalLocking implements Multicompany, Historical, OptimisticLocking {
    ...
    public Person(PersonPk pk, String name, String lastName, String identificationTypeId, String identificationNumber, Date dateOfBirth, String genderTypeId, String civilStatusId, String countryId) {
        this.pk = pk;
        this.name = name;
    ...
    public String toString() {
        return "PERSON:[" + this.getPk().toString() + ", " + this.getCreated()
                ...
                + ", " + this.getGenderTypeId() + ", " + this.getCivilStatusId()
                + ", " + this.getCountryId() + ", " + this.getProvinceId()
                + ", " + this.getCityId() + ", " + this.getProfessionTypeId()
                + ", " + this.getVersion() + "]";
    }
}
