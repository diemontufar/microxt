...
/**
 * The persistent class for the ENTITY_TABLE database table.
 * Values of entity tables
 */
@Entity
...
public class EntityTable extends AbstractEntity implements Multicompany {
    ...
    public EntityTable(EntityTablePk pk, Boolean hasTableId, String packageName, Boolean multiCompany, Boolean multiLanguage, Boolean historicalData, Boolean optimisticLocking, Boolean enumeratedTypes, Boolean cacheMemory, String description) {
        this.pk = pk;
    ...
    public String toString() {
        return "ENTITY_TABLE:[" + this.getPk().toString() + ", "
                ...
                + this.getHistoricalData() + ", " + this.getOptimisticLocking()
                + ", " + this.getEnumeratedTypes() + ", "
                + this.getCacheMemory() + ", " + this.getDescription() + "]";
    }
}
