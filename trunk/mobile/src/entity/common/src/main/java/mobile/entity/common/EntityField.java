...
public class EntityField extends AbstractEntity implements Multicompany {
    ...
    public EntityField(EntityFieldPk pk, Integer fieldOrder, String dataTypeId, Integer dataSize, Integer dataScale, Boolean primaryKey, Boolean uniqueKey, Boolean nullable, Integer securityLevel, Boolean readonly, Boolean hidden) {
        this.pk = pk;
