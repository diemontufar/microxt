...
/**
 * The persistent class for the WORKFLOW_PROCESS database table. Values of
 * workflow processes
 */
@Entity
...
public class WorkflowProcess extends AbstractEntity implements Multicompany {
	...
	public WorkflowProcess(WorkflowProcessPk pk, String subsystemId,
			String moduleId, String processId) {
		this.pk = pk;
