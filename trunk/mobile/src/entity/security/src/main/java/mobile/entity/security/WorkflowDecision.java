...
/**
 * The persistent class for the WORKFLOW_DECISION database table.
 * Values of workflow decisions
 */
@Entity
...
public class WorkflowDecision extends AbstractEntity implements Multicompany {
    ...
    public WorkflowDecision(WorkflowDecisionPk pk, String decisionRule, String workflowStepId) {
        this.pk = pk;
