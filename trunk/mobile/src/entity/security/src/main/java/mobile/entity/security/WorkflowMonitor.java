...
/**
 * The persistent class for the WORKFLOW_MONITOR database table.
 * Values of workflow monitor
 */
@Entity
@Table(name = "WORKFLOW_MONITOR")
public class WorkflowMonitor extends AbstractHistoricalLocking implements Multicompany, Historical, OptimisticLocking {
    ...
    public WorkflowMonitor(WorkflowMonitorPk pk, Date jobDate, String userId, Long workflowId, Integer workflowSequence, String workflowStatusId, String subsystemId, String moduleId, String processId, String authorizerId) {
        this.pk = pk;
    ...
    public String toString() {
        return "WORKFLOW_MONITOR:[" + this.getPk().toString() + ", "
                ...
                + this.getWorkflowSequence() + ", " + this.getWorkflowStatusId()
                + ", " + this.getSubsystemId() + ", " + this.getModuleId()
                + ", " + this.getProcessId() + ", " + this.getAuthorizerId()
                + ", " + this.getVersion() + "]";
    }
}
