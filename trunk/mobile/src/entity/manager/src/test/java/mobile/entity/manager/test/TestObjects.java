...
import mobile.entity.parameter.BranchPk;
...
public class TestObjects {
	...
	public TestObjects(){
		...
		Parameter param = new Parameter(new ParameterPk("PRUEBA"), "AS", "String", "10", "PARAMTETRO DE PRUEBA");
		Branch branch = new Branch(new BranchPk("1"), "ASDFASDFASDF");
		Country country = new Country(new CountryPk("AB"), "ASFDASDFASFD");
		Province province = new Province(new ProvincePk("AB","Cd"), "QEWRQEWRQWERQWER");
		// Group entities
