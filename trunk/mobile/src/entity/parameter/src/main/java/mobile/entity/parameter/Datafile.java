...
/**
 * The persistent class for the DATAFILE database table.
 * Values of datafiles
 */
@Entity
@Table(name = "DATAFILE")
public class Datafile extends AbstractHistoricalLocking implements Multicompany, Historical, OptimisticLocking {
    ...
    public String toString() {
        return "DATAFILE:[" + this.getPk().toString() + ", " + this.getCreated()
                + ", " + this.getDatafileTypeId() + ", " + this.getBinaryPath()
                + ", " + this.getBinaryBytes() + ", " + this.getBinaryObject()
