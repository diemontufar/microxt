...
@MappedSuperclass
public abstract class AbstractCompanyLanguageHistoricalKey extends AbstractEntityKey
	...
	public boolean equals(Object other) {
		...
		AbstractCompanyLanguageHistoricalKey castOther = 
			(AbstractCompanyLanguageHistoricalKey)other;
		return
