...
* Recommendation of microcredit
*/
@Entity
@Table(name="RECOMMENDATION")
public class Recommendation extends AbstractHistoricalLocking implements Multicompany, Multilanguage, Historical, OptimisticLocking{
...
public Recommendation(RecommendationPk pk,String documents,String economicUnit,String familyUnit,String paymentMorale,String creditHistory,String proposal) {
this.pk = pk;
...
this.getCreated() + ", " +
this.getDocuments() + ", " +
this.getEconomicUnit() + ", " +
this.getFamilyUnit() + ", " +
this.getPaymentMorale() + ", " +
