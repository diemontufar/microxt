...
//			SqlGeneratorAllinOneFile sqlGenerator = new SqlGeneratorAllinOneFile("MYSQL","/home/ronald/TesisOutput");
//			sqlGenerator.execute();
			
			// Sql Generator - Different files per package
//			SqlGenerator sqlGenerator = new SqlGenerator("MYSQL","/home/ronald/TesisOutput");
//			sqlGenerator.execute();
			...
			EntityGenerator entityGenerator = new EntityGenerator(company, outputFolder, outputUpperPackage);
