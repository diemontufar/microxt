...
public class B007 extends MyGeneralForm {

	private final static String PROCESS = "B006";
	private final static String ENTITY = "PhoneType";
	...
	protected void onRender(Element parent, int index) {
		...
		cdata.add(new MyColumnData("pk_phoneTypeId", "Tipo", 70, 3, false));
		...
		// Content panel
		EntityContentPanel cp = new EntityContentPanel("Tipos de Telefono", 400, 230);
