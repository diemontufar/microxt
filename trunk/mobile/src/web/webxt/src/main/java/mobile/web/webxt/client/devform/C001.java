...
public class C001 extends MyGeneralForm {
	...
	private final static String PROCESS = "C001";
	private final static String ENTITY = "Currency";
	...
	protected void onRender(Element parent, int index) {
		...
		cdata.add(new MyColumnData("pk_currencyId", "Moneda", 70, 3, false));
		cdata.add(new MyColumnData("description", "Descripcion", 150, 50, false));
		cdata.add(new MyColumnData("initials", "Simbolo", 70, 3, true));
		...
		// Content panel
		EntityContentPanel cp = new EntityContentPanel("Monedas", 400, 230);
