...
public class C004 extends LayoutContainer {

	private final String PROCESS = "C004";

	private final String ENTITY = "Frequency";
	...
	protected void onRender(Element parent, int index) {
		...
		// Content panel
		EntityContentPanel cp = new EntityContentPanel("Frecuencias",
				400, 230);
