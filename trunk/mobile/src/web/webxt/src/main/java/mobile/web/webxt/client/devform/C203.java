...
//		row.add(label);
//
//		codigo = new InputBox( 80, 11, Validate.ALPHANUMERIC);
//		codigo.setDataSource(new DataSource("grp", "pk_partnerGroupId", DataSourceType.CRITERION));
...
//		row.setHeight(70);
//				
//		description=new MyTextArea(170,100);
//		description.setDataSource(new DataSource("grp", "groupDescription", DataSourceType.RECORD));
...
//		row.setHeight(100);
//
//		activity = new MyTextArea(170, 300);
//		activity.setDataSource(new DataSource("grp", "activity", DataSourceType.RECORD));
