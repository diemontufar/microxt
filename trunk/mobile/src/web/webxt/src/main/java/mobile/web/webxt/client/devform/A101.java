...
public class A101 extends MyGeneralForm {

	private final static String PROCESS = "A101";
	private final static String ENTITY = "UserStatus";
	...
	protected void onRender(Element parent, int index) {
		...
		cdata.add(new MyColumnData("pk_userStatusId", "Estatus", 70, 4, false));
		...
		// Content panel
		EntityContentPanel cp = new EntityContentPanel("Estado de Usuarios", 400, 230);
