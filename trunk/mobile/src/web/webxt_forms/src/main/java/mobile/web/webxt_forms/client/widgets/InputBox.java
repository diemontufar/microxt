...
import mobile.web.webxt_forms.client.validator.ValidationTypes;
import mobile.web.webxt_forms.client.validator.ValidationTypesValidator;
...
public class InputBox extends TextField<String> {
	...
	private void createInput() {
		...
		if (type.compareTo("txt-alfanum") == 0) {
			setValidator(new ValidationTypesValidator(
					ValidationTypes.ALPHANUMERIC));
			setAllowBlank(true);
		}
