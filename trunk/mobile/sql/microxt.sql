...
CREATE TABLE `ROLE` (
  ...
  `MODULE_ID` varchar(2) NOT NULL,
  `PROCESS_ID` varchar(2) NOT NULL,
  `DAY_ID` varchar(3) NOT NULL DEFAULT '',
  `CREATED` datetime NOT NULL,
...
-- Dump completed on 2012-02-27 10:04:51
