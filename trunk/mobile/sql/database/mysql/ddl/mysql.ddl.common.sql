...
CREATE TABLE SEQUENTIAL (
	COMPANY_ID VARCHAR(4) NOT NULL, 
	SEQUENTIAL_ID VARCHAR(40) NOT NULL, 
	SEQUENTIAL_VALUE INTEGER(10) DEFAULT 0 NOT NULL, 
...
CREATE TABLE ENTITY_FIELD (
	...
	DATA_TYPE_ID VARCHAR(30) NOT NULL, 
	DATA_SIZE SMALLINT(5) NOT NULL, 
	DATA_SCALE TINYINT(3) DEFAULT 0 NOT NULL, 
	...
	SECURITY_LEVEL TINYINT(3) DEFAULT 0 NOT NULL, 
