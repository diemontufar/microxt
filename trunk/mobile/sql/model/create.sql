...
ALTER TABLE MICRO_ACCOUNT ADD CONSTRAINT MIC_ACC_REN_ACC_FK FOREIGN KEY (RENEWED_ACCOUNT) REFERENCES MICRO_ACCOUNT_ID (ACCOUNT_ID);
...
ALTER TABLE SOLICITUDE ADD CONSTRAINT SOLICITUDE_REN_ACC_FK FOREIGN KEY (RENEWED_ACCOUNT) REFERENCES MICRO_ACCOUNT_ID (ACCOUNT_ID);
