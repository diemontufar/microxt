...
CREATE TABLE MESSAGE_COPY (
	...
	COPY_SEQUENCE TINYINT NOT NULL,
...
CREATE TABLE MESSAGE_FIELD (
	...
	FIELD_ORDER TINYINT NOT NULL,
	FIELD_INIT TINYINT,
	FIELD_LENGTH TINYINT,
	FIELD_FILLED VARCHAR(1),
	FIELD_ALIGN VARCHAR(1),
...
CREATE TABLE MESSAGE_LOG (
	...
	PROCESSING_TIME DECIMAL(6,4),
	MESSAGE_TEXT VARCHAR(4000),
	RESPONSE_ID VARCHAR(8),
	REVERSE_ID VARCHAR(100),
	VERSION BIGINT NOT NULL DEFAULT '0',
...
CREATE TABLE MESSAGE_ROUTER (
	...
	MODULE_ID VARCHAR(2) NOT NULL,
	PROCESS_ID VARCHAR(2) NOT NULL,
	ROUTER_SEQUENCE TINYINT NOT NULL,
	CREATED DATETIME NOT NULL,
...
CREATE TABLE WORKFLOW_DECISION_ID (
	DECISION_ID VARCHAR(4) NOT NULL,
	DECISION_SEQUENCE TINYINT NOT NULL,
...
CREATE TABLE WORKFLOW_DECISION (
	...
	CHANNEL_ID VARCHAR(4),
	SUBSYSTEM_ID VARCHAR(2),
	MODULE_ID VARCHAR(2),
	PROCESS_ID VARCHAR(2),
	PROCESS_SEQUENCE TINYINT,
...
CREATE TABLE WORKFLOW_MONITOR (
	...
	WORKFLOW_SEQUENCE TINYINT NOT NULL,
...
CREATE TABLE WORKFLOW_PROCESS_ID (
	WORKFLOW_ID INTEGER NOT NULL,
	WORKFLOW_SEQUENCE TINYINT NOT NULL,
...
CREATE TABLE WORKFLOW_STATUS_ID (
	WORKFLOW_STATUS_ID VARCHAR(4) NOT NULL,
...
ALTER TABLE BRANCH ADD CONSTRAINT BRANCH_BRANCH_ID_FK FOREIGN KEY (BRANCH_ID) REFERENCES BRANCH_ID (BRANCH_ID);
ALTER TABLE BRANCH ADD CONSTRAINT BRANCH_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
...
ALTER TABLE CONTROLLER ADD CONSTRAINT CONTROLLER_COMPONENT_ID_FK FOREIGN KEY (COMPONENT_ID) REFERENCES COMPONENT_ID (COMPONENT_ID);
...
ALTER TABLE DEPARTMENT ADD CONSTRAINT DEPARTMENT_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
ALTER TABLE DEPARTMENT ADD CONSTRAINT DEPARTMENT_DEPARTMENT_ID_FK FOREIGN KEY (BRANCH_ID, OFFICE_ID, DEPARTMENT_ID) REFERENCES DEPARTMENT_ID (BRANCH_ID, OFFICE_ID, DEPARTMENT_ID);
ALTER TABLE DEPARTMENT ADD CONSTRAINT DEPARTMENT_LANGUAGE_FK FOREIGN KEY (LANGUAGE_ID) REFERENCES LANGUAGE (LANGUAGE_ID);
ALTER TABLE DEPARTMENT_ID ADD CONSTRAINT DEPARTMENT_ID_OFFICE_ID_FK FOREIGN KEY (BRANCH_ID, OFFICE_ID) REFERENCES OFFICE_ID (BRANCH_ID, OFFICE_ID);
...
ALTER TABLE HOST ADD CONSTRAINT HOST_CHANNEL_ID_FK FOREIGN KEY (CHANNEL_ID) REFERENCES CHANNEL (CHANNEL_ID);
...
ALTER TABLE HOST ADD CONSTRAINT HOST_OFFICE_ID_FK FOREIGN KEY (BRANCH_ID, OFFICE_ID) REFERENCES OFFICE_ID (BRANCH_ID, OFFICE_ID);
...
ALTER TABLE MESSAGE_COPY ADD CONSTRAINT MESSAGE_COPY_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
ALTER TABLE MESSAGE_COPY ADD CONSTRAINT MESSAGE_COPY_MESS_TYPE_ID_FK FOREIGN KEY (MESSAGE_TYPE_ID) REFERENCES MESSAGE_TYPE_ID (MESSAGE_TYPE_ID);
ALTER TABLE MESSAGE_COPY ADD CONSTRAINT MESSAGE_COPY_TYPE_ID_FK FOREIGN KEY (MESSAGE_TYPE_COPY) REFERENCES MESSAGE_TYPE_ID (MESSAGE_TYPE_ID);
ALTER TABLE MESSAGE_FIELD ADD CONSTRAINT MESSAGE_FIELD_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
ALTER TABLE MESSAGE_FIELD ADD CONSTRAINT MESSAGE_FIELD_MESS_TYPE_ID_FK FOREIGN KEY (MESSAGE_TYPE_ID) REFERENCES MESSAGE_TYPE_ID (MESSAGE_TYPE_ID);
ALTER TABLE MESSAGE_LOG ADD CONSTRAINT MESSAGE_LOG_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
ALTER TABLE MESSAGE_LOG ADD CONSTRAINT MESSAGE_LOG_HOST_ID_FK FOREIGN KEY (HOST_ID) REFERENCES HOST_ID (HOST_ID);
ALTER TABLE MESSAGE_LOG ADD CONSTRAINT MESSAGE_LOG_MESSAGE_TYPE_ID_FK FOREIGN KEY (MESSAGE_TYPE_ID) REFERENCES MESSAGE_TYPE_ID (MESSAGE_TYPE_ID);
ALTER TABLE MESSAGE_LOG ADD CONSTRAINT MESSAGE_LOG_PROCESS_ID_FK FOREIGN KEY (SUBSYSTEM_ID, MODULE_ID, PROCESS_ID) REFERENCES PROCESS_ID (SUBSYSTEM_ID, MODULE_ID, PROCESS_ID);
ALTER TABLE MESSAGE_LOG ADD CONSTRAINT MESSAGE_LOG_SERVICE_ID_FK FOREIGN KEY (SERVICE_ID) REFERENCES SERVICE_ID (SERVICE_ID);
ALTER TABLE MESSAGE_LOG ADD CONSTRAINT MESSAGE_LOG_USER_ACCOUNT_ID_FK FOREIGN KEY (USER_ID) REFERENCES USER_ACCOUNT_ID (USER_ID);
ALTER TABLE MESSAGE_MAP ADD CONSTRAINT MESSAGE_MAP_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
ALTER TABLE MESSAGE_MAP ADD CONSTRAINT MESSAGE_MAP_COMPONENT_ID_FK FOREIGN KEY (COMPONENT_ID) REFERENCES COMPONENT_ID (COMPONENT_ID);
ALTER TABLE MESSAGE_MAP ADD CONSTRAINT MESSAGE_MAP_MESSAGE_TYPE_ID_FK FOREIGN KEY (MESSAGE_TYPE_ID) REFERENCES MESSAGE_TYPE_ID (MESSAGE_TYPE_ID);
ALTER TABLE MESSAGE_MAP ADD CONSTRAINT MESSAGE_MAP_TYPE_ID_FK FOREIGN KEY (MESSAGE_TYPE_MAP) REFERENCES MESSAGE_TYPE_ID (MESSAGE_TYPE_ID);
ALTER TABLE MESSAGE_ROUTER ADD CONSTRAINT MESSAGE_ROUTER_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
ALTER TABLE MESSAGE_ROUTER ADD CONSTRAINT MESSAGE_ROUTER_MESS_TYPE_ID_FK FOREIGN KEY (MESSAGE_TYPE_ID) REFERENCES MESSAGE_TYPE_ID (MESSAGE_TYPE_ID);
ALTER TABLE MESSAGE_ROUTER ADD CONSTRAINT MESSAGE_ROUTER_PROCESS_ID_FK FOREIGN KEY (SUBSYSTEM_ID, MODULE_ID, PROCESS_ID) REFERENCES PROCESS_ID (SUBSYSTEM_ID, MODULE_ID, PROCESS_ID);
ALTER TABLE MESSAGE_ROUTER ADD CONSTRAINT MESSAGE_ROUTER_SERVICE_ID_FK FOREIGN KEY (SERVICE_ROUTER) REFERENCES SERVICE_ID (SERVICE_ID);
ALTER TABLE MESSAGE_ROUTER ADD CONSTRAINT MESSAGE_ROUTER_SERV_ID_FK FOREIGN KEY (SERVICE_ID) REFERENCES SERVICE_ID (SERVICE_ID);
ALTER TABLE MESSAGE_ROUTER ADD CONSTRAINT MESSAGE_ROUTER_TYPE_ID_FK FOREIGN KEY (MESSAGE_TYPE_ROUTER) REFERENCES MESSAGE_TYPE_ID (MESSAGE_TYPE_ID);
ALTER TABLE MESSAGE_TYPE ADD CONSTRAINT MESSAGE_TYPE_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
ALTER TABLE MESSAGE_TYPE ADD CONSTRAINT MESSAGE_TYPE_COMPONENT_ID_FK FOREIGN KEY (COMPONENT_ID) REFERENCES COMPONENT_ID (COMPONENT_ID);
ALTER TABLE MESSAGE_TYPE ADD CONSTRAINT MESSAGE_TYPE_ID_FK FOREIGN KEY (MESSAGE_TYPE_ID) REFERENCES MESSAGE_TYPE_ID (MESSAGE_TYPE_ID);
...
ALTER TABLE OFFICE ADD CONSTRAINT OFFICE_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
ALTER TABLE OFFICE ADD CONSTRAINT OFFICE_OFFICE_ID_FK FOREIGN KEY (BRANCH_ID, OFFICE_ID) REFERENCES OFFICE_ID (BRANCH_ID, OFFICE_ID);
ALTER TABLE OFFICE_ID ADD CONSTRAINT OFFICE_ID_BRANCH_ID_FK FOREIGN KEY (BRANCH_ID) REFERENCES BRANCH_ID (BRANCH_ID);
...
ALTER TABLE PROCESS ADD CONSTRAINT PROCESS_WORKFLOW_PROCESS_ID_FK FOREIGN KEY (WORKFLOW_ID) REFERENCES WORKFLOW_PROCESS_ID (WORKFLOW_ID);
ALTER TABLE PROCESS_COMPONENT ADD CONSTRAINT PROCESS_COMPONENT_CHANNE_ID_FK FOREIGN KEY (CHANNEL_ID) REFERENCES CHANNEL (CHANNEL_ID);
...
ALTER TABLE PROCESS_COMPONENT ADD CONSTRAINT PROCESS_COMP_WORKF_DECIS_ID_FK FOREIGN KEY (DECISION_ID) REFERENCES WORKFLOW_DECISION_ID (DECISION_ID);
...
ALTER TABLE SERVICE ADD CONSTRAINT SERVICE_CHANNEL_ID_FK FOREIGN KEY (CHANNEL_ID) REFERENCES CHANNEL (CHANNEL_ID);
ALTER TABLE SERVICE ADD CONSTRAINT SERVICE_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
ALTER TABLE SERVICE ADD CONSTRAINT SERVICE_CONTROLLER_ID_FK FOREIGN KEY (CONTROLLER_ID) REFERENCES CONTROLLER (CONTROLLER_ID);
ALTER TABLE SERVICE ADD CONSTRAINT SERVICE_ID_FK FOREIGN KEY (SERVICE_ID) REFERENCES SERVICE_ID (SERVICE_ID);
ALTER TABLE SERVICE ADD CONSTRAINT SERVICE_SERVICE_ID_FK FOREIGN KEY (SERVER_ID) REFERENCES SERVER (SERVER_ID);
ALTER TABLE SERVICE_PARAMETER ADD CONSTRAINT SERVICE_PARAMETER_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
ALTER TABLE SERVICE_PARAMETER ADD CONSTRAINT SERVICE_PARAM_PARAMETER_ID_FK FOREIGN KEY (PARAMETER_ID) REFERENCES PARAMETER_ID (PARAMETER_ID);
ALTER TABLE SERVICE_PARAMETER ADD CONSTRAINT SERVICE_PARAM_SERVICE_ID_FK FOREIGN KEY (SERVICE_ID) REFERENCES SERVICE_ID (SERVICE_ID);
...
ALTER TABLE WORKFLOW_DECISION ADD CONSTRAINT WORKFLOW_DECISION_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
ALTER TABLE WORKFLOW_DECISION ADD CONSTRAINT WORKFLOW_DECISION_ID_FK FOREIGN KEY (DECISION_ID) REFERENCES WORKFLOW_DECISION_ID (DECISION_ID);
ALTER TABLE WORKFLOW_DECISION ADD CONSTRAINT WORKFLOW_DECIS_CHANNEL_ID_FK FOREIGN KEY (CHANNEL_ID) REFERENCES CHANNEL (CHANNEL_ID);
ALTER TABLE WORKFLOW_DECISION ADD CONSTRAINT WORKFLOW_DECIS_PROCESS_ID_FK FOREIGN KEY (SUBSYSTEM_ID, MODULE_ID, PROCESS_ID) REFERENCES PROCESS_ID (SUBSYSTEM_ID, MODULE_ID, PROCESS_ID);
ALTER TABLE WORKFLOW_DECISION ADD CONSTRAINT WORKFLOW_DECIS_STEP_ID_FK FOREIGN KEY (WORKFLOW_STEP_ID) REFERENCES WORKFLOW_STEP_ID (WORKFLOW_STEP_ID);
ALTER TABLE WORKFLOW_MONITOR ADD CONSTRAINT WORKFLOW_MONITOR_AUTH_ID_FK FOREIGN KEY (AUTHORIZER_ID) REFERENCES USER_ACCOUNT_ID (USER_ID);
ALTER TABLE WORKFLOW_MONITOR ADD CONSTRAINT WORKFLOW_MONITOR_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
ALTER TABLE WORKFLOW_MONITOR ADD CONSTRAINT WORKFLOW_MONITOR_PROCESS_ID_FK FOREIGN KEY (SUBSYSTEM_ID, MODULE_ID, PROCESS_ID) REFERENCES PROCESS_ID (SUBSYSTEM_ID, MODULE_ID, PROCESS_ID);
ALTER TABLE WORKFLOW_MONITOR ADD CONSTRAINT WORKFLOW_MONITOR_STATUS_ID_FK FOREIGN KEY (WORKFLOW_STATUS_ID) REFERENCES WORKFLOW_STATUS_ID (WORKFLOW_STATUS_ID);
ALTER TABLE WORKFLOW_MONITOR ADD CONSTRAINT WORKFLOW_MONITOR_USER_ID_FK FOREIGN KEY (USER_ID) REFERENCES USER_ACCOUNT_ID (USER_ID);
ALTER TABLE WORKFLOW_MONITOR ADD CONSTRAINT WORKFLOW_MONITOR_WF_PROC_ID_FK FOREIGN KEY (WORKFLOW_ID) REFERENCES WORKFLOW_PROCESS_ID (WORKFLOW_ID);
ALTER TABLE WORKFLOW_PROCESS ADD CONSTRAINT WORKFLOW_PROCESS_COMPANY_FK FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY (COMPANY_ID);
ALTER TABLE WORKFLOW_PROCESS ADD CONSTRAINT WORKFLOW_PROCESS_ID_FK FOREIGN KEY (WORKFLOW_ID) REFERENCES WORKFLOW_PROCESS_ID (WORKFLOW_ID);
ALTER TABLE WORKFLOW_PROCESS ADD CONSTRAINT WORKFLOW_PROCESS_PROCESS_ID_FK FOREIGN KEY (SUBSYSTEM_ID, MODULE_ID, PROCESS_ID) REFERENCES PROCESS_ID (SUBSYSTEM_ID, MODULE_ID, PROCESS_ID);
ALTER TABLE WORKFLOW_STATUS ADD CONSTRAINT WORKFLOW_STATUS_ID_FK FOREIGN KEY (WORKFLOW_STATUS_ID) REFERENCES WORKFLOW_STATUS_ID (WORKFLOW_STATUS_ID);
ALTER TABLE WORKFLOW_STATUS ADD CONSTRAINT WORKFLOW_STATUS_LANGUAGE_FK FOREIGN KEY (LANGUAGE_ID) REFERENCES LANGUAGE (LANGUAGE_ID);
ALTER TABLE WORKFLOW_STEP ADD CONSTRAINT WORKFLOW_STEP_ID_FK FOREIGN KEY (WORKFLOW_STEP_ID) REFERENCES WORKFLOW_STEP_ID (WORKFLOW_STEP_ID);
ALTER TABLE WORKFLOW_STEP ADD CONSTRAINT WORKFLOW_STEP_LANGUAGE_FK FOREIGN KEY (LANGUAGE_ID) REFERENCES LANGUAGE (LANGUAGE_ID);
