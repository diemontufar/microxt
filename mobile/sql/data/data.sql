...
INSERT INTO LANGUAGE VALUES ('ES', 'ESPA�OL');
...
insert into ADDRESS_TYPE (COMPANY_ID, LANGUAGE_ID, ADDRESS_TYPE_ID, NAME) values ('MXT', 'ES', 'CE', 'CORREO ELECTR�NICO');
...
insert into PROFESSION_TYPE (COMPANY_ID, LANGUAGE_ID, PROFESSION_TYPE_ID, NAME) values ('MXT','ES','9','ALBA�IL');
...
insert into PROFESSION_TYPE (COMPANY_ID, LANGUAGE_ID, PROFESSION_TYPE_ID, NAME) values ('MXT','ES','43','DISE�ADOR');
insert into PROFESSION_TYPE (COMPANY_ID, LANGUAGE_ID, PROFESSION_TYPE_ID, NAME) values ('MXT','ES','44','DUE�O TALLER');
insert into PROFESSION_TYPE (COMPANY_ID, LANGUAGE_ID, PROFESSION_TYPE_ID, NAME) values ('MXT','ES','45','DUE�O TALLER REJAS');
insert into PROFESSION_TYPE (COMPANY_ID, LANGUAGE_ID, PROFESSION_TYPE_ID, NAME) values ('MXT','ES','46','DUE�O TIENDA');
insert into PROFESSION_TYPE (COMPANY_ID, LANGUAGE_ID, PROFESSION_TYPE_ID, NAME) values ('MXT','ES','47','DUE�O COMPANIA CONSTRUCCION');
insert into PROFESSION_TYPE (COMPANY_ID, LANGUAGE_ID, PROFESSION_TYPE_ID, NAME) values ('MXT','ES','48','DUE�O DE RESTAURANTE');
insert into PROFESSION_TYPE (COMPANY_ID, LANGUAGE_ID, PROFESSION_TYPE_ID, NAME) values ('MXT','ES','49','DUE�O RESTAURANTE MOBIL');
insert into PROFESSION_TYPE (COMPANY_ID, LANGUAGE_ID, PROFESSION_TYPE_ID, NAME) values ('MXT','ES','50','DUE�O SUPERMERCADO');
...
insert into OPERATIVE_CONDITION (COMPANY_ID, LANGUAGE_ID, OPERATIVE_CONDITION_ID, DESCRIPTION) values ('MXT', 'ES', 'INS', 'INSTRUMENTACI�N PENDIENTE');
...
insert into QUOTA_TYPE (COMPANY_ID, LANGUAGE_ID, QUOTA_TYPE_ID, DESCRIPTION) values ('MXT', 'ES', 'AMR', 'AMORTIZACI�N GRADUAL');
