...
* Solicitude of microcredit
*/
@Entity
@Table(name="SOLICITUDE")
public class Solicitude extends AbstractHistoricalLocking implements Multicompany, Multilanguage, Historical, OptimisticLocking{
...
public Solicitude(SolicitudePk pk,String assessor,Date solicitudeDate,String productId,String statusId,Integer numberRenewal,BigDecimal amount,Long term,String quotaTypeId,Integer numberQuotas,String paymentFrequencyId,String fundsDestinationId,String destinationDescription) {
this.pk = pk;
...
this.getAccount() + ", " +
this.getAssessor() + ", " +
this.getPartnerClientId() + ", " +
this.getGroupClientId() + ", " +
this.getSolicitudeDate() + ", " +
this.getApprovalDate() + ", " +
this.getDisbursementDate() + ", " +
this.getExpirationDate() + ", " +
this.getProductId() + ", " +
this.getStatusId() + ", " +
this.getNumberRenewal() + ", " +
this.getAmount() + ", " +
this.getTerm() + ", " +
this.getQuotaTypeId() + ", " +
this.getNumberQuotas() + ", " +
this.getPaymentFrequencyId() + ", " +
