...
public Solicitude(SolicitudePk pk,String assessor,Date solicitudeDate,Date expirationDate,String productId,String solicitudeStatusId,Integer numberRenewal,BigDecimal amount,Long term,String feeTypeId,Integer numberFees,String paymentFrequencyId,String fundsDestinationId,String destinationDescription) {
this.pk = pk;
