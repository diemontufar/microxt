...
/**
* The persistent class for the PRODUCT_MICROCREDIT database table.
* Products of microcredit
*/
@Entity
...
public ProductMicrocredit(ProductMicrocreditPk pk,String description,String currencyId,BigDecimal minAmount,BigDecimal maxAmount,Long minPeriod,Long maxPeriod,BigDecimal rate) {
this.pk = pk;
