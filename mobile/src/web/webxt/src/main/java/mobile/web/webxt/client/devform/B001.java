...
public class B001 extends MyGeneralForm {

	private final static String PROCESS = "B001";
	private final static String ENTITY = "PersonType";
	...
	protected void onRender(Element parent, int index) {
		...
		cdata.add(new MyColumnData("pk_personTypeId", "Tipo", 70, 3, false));
		...
		// Content panel
		EntityContentPanel cp = new EntityContentPanel("Tipos de Persona", 400, 230);
