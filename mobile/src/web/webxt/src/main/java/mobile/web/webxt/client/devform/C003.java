...
public class C003 extends MyGeneralForm {

	private final static String PROCESS = "C003";
	private final static String ENTITY = "QuotaType";
	...
	protected void onRender(Element parent, int index) {
		...
		// Content panel
		EntityContentPanel cp = new EntityContentPanel("Tipos de Cuota", 400, 230);
