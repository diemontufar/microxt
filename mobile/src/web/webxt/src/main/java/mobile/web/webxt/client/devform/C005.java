...
public class C005 extends MyGeneralForm {

	private final static String PROCESS = "C005";
	private final static String ENTITY = "FundsDestination";
	...
	protected void onRender(Element parent, int index) {
		...
		// Content panel
		EntityContentPanel cp = new EntityContentPanel("Destinos de fondos", 400, 230);
