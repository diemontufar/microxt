...
public class B003 extends MyGeneralForm {

	private final static String PROCESS = "B003";
	private final static String ENTITY = "GenderType";
	...
	protected void onRender(Element parent, int index) {
		...
		cdata.add(new MyColumnData("pk_genderTypeId", "Tipo", 70, 3, false));
		...
		// Content panel
		EntityContentPanel cp = new EntityContentPanel("Tipos de Genero", 400, 230);
