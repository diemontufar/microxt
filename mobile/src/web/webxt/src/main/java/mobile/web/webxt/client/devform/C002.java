...
public class C002 extends MyGeneralForm {

	private final static String PROCESS = "C002";
	private final static String ENTITY = "SolicitudeStatus";
	...
	protected void onRender(Element parent, int index) {
		...
		cdata.add(new MyColumnData("pk_statusId", "Estatus", 70, 3, false));
		...
		// Content panel
		EntityContentPanel cp = new EntityContentPanel("Estatus de Solicitud", 400, 230);
