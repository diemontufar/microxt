...
public class B002 extends MyGeneralForm {

	private final static String PROCESS = "B002";
	private final static String ENTITY = "IdentificationType";
	...
	protected void onRender(Element parent, int index) {
		...
		cdata.add(new MyColumnData("pk_identificationTypeId", "Tipo", 70, 3, false));
		...
		// Content panel
		EntityContentPanel cp = new EntityContentPanel("Tipos de Identificacion", 400, 230);
