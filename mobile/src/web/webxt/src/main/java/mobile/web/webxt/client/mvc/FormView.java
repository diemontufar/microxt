...
import mobile.web.webxt.client.devform.C503;
import mobile.web.webxt.client.devform.C504;
...
public class FormView extends View {
	...
	private MyGeneralForm getForm(String processId) {
		...
		if (processId.compareTo("A101") == 0) {
			...
			form = new C105();
		} else if (processId.compareTo("C106") == 0) {
			form = new C106();
			...
			form = new C502();
		} else if (processId.compareTo("C503") == 0) {
			form = new C503();
		} else if (processId.compareTo("C504") == 0) {
			form = new C504();
