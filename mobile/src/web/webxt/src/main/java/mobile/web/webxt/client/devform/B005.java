...
public class B005 extends MyGeneralForm {
	...
	private final static String PROCESS = "B005";
	private final static String ENTITY = "ProfessionType";
	...
	protected void onRender(Element parent, int index) {
		...
		cdata.add(new MyColumnData("pk_professionTypeId", "Tipo", 70, 3, false));
		...
		// Content panel
		EntityContentPanel cp = new EntityContentPanel("Tipos de Profesion", 400, 230);
